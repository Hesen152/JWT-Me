...
namespace Business.Concrete
{
    public class AuthManager : IAuthService
    {
        ...
        public IDataResult<User> Register(UserForRegisterDto userForRegisterDto, string password)
        {
           ...
           HashingHelper.createPasswordHash(password, out passwrodHash, out passwordSalt);
            var user = new User
            {
                ...
                status = true  /// email ile dogrulmadan sonra false de elmek olar baxir  veziyyete 
